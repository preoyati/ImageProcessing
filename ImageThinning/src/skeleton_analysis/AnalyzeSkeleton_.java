...
public class AnalyzeSkeleton_ implements PlugInFilter
{
	...
	public ArrayList< Double > shortestPathList;
	...
	public ImageStack shortPathImage = null;
			...
			boolean verbose)
	{
		...
		if(shortPath)
		{
			...
			if (!silent) {
				...
				ImagePlus shortIP = new ImagePlus("Longest shortest paths Amjad", shortPathImage);
				
				
				OurImage =new ImagePlus("Result",shortIP.getProcessor());
				shortIP.show();
	 ...
	 * @param verbose flag to display running information 
	 */
	public ImagePlus returnImageLong()
	{
			...
			boolean verbose)
	{
		...
		if(shortPath)
		{
			...
			if (!silent) {
				// Display short paths in a new stack
				ImagePlus shortIP = new ImagePlus("Longest shortest paths Mahesh", shortPathImage);
				//OurImage =shortIP;
				shortIP.show();
